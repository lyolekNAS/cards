...
public class WordControllerApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public WordDto findWordCard(String w) throws RestClientException {
        return findWordCardWithHttpInfo(w).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<WordDto> findWordCardWithHttpInfo(String w) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'w' is set
        if (w == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'w' when calling findWordCard");
        }
        ...
        ParameterizedTypeReference<WordDto> localReturnType = new ParameterizedTypeReference<WordDto>() {};
        return apiClient.invokeAPI("/api/word/find-card", HttpMethod.GET, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public WordDto getWordById(Long id) throws RestClientException {
        return getWordByIdWithHttpInfo(id).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<WordDto> getWordByIdWithHttpInfo(Long id) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling getWordById");
        }
        ...
        ParameterizedTypeReference<WordDto> localReturnType = new ParameterizedTypeReference<WordDto>() {};
        return apiClient.invokeAPI("/api/word/{id}", HttpMethod.GET, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Integer pickRandom5FromPause() throws RestClientException {
        return pickRandom5FromPauseWithHttpInfo().getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Integer> pickRandom5FromPauseWithHttpInfo() throws RestClientException {
        Object localVarPostBody = null;
        ...
        return apiClient.invokeAPI("/api/word/pick5Paused", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
