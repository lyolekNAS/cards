...
public class DictionaryControllerApi {
     ...
     */
    public WordDto enrichWithAiTranslations(String word) throws RestClientException {
        return enrichWithAiTranslationsWithHttpInfo(word).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<WordDto> enrichWithAiTranslationsWithHttpInfo(String word) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'word' is set
        if (word == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'word' when calling enrichWithAiTranslations");
        }
        ...
        localVarQueryParams.putAll(apiClient.parameterToMultiValueMap(null, "word", word));
        ...
        return apiClient.invokeAPI("/api/dict/enrichWithAiTranslations", HttpMethod.GET, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public WordDto enrichWithExamples(String word) throws RestClientException {
        return enrichWithExamplesWithHttpInfo(word).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<WordDto> enrichWithExamplesWithHttpInfo(String word) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'word' is set
        if (word == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'word' when calling enrichWithExamples");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public WordDto findWordToSuggest() throws RestClientException {
        return findWordToSuggestWithHttpInfo().getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<WordDto> findWordToSuggestWithHttpInfo() throws RestClientException {
        Object localVarPostBody = null;
        ...
        ParameterizedTypeReference<WordDto> localReturnType = new ParameterizedTypeReference<WordDto>() {};
        return apiClient.invokeAPI("/api/dict/findWordToSuggest", HttpMethod.GET, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public WordDto findWordToSuggest1(Integer level) throws RestClientException {
        return findWordToSuggest1WithHttpInfo(level).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<WordDto> findWordToSuggest1WithHttpInfo(Integer level) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'level' is set
        if (level == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'level' when calling findWordToSuggest1");
        }
