...
public class DictionaryControllerApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public String enrichWithSpeech(String word) throws RestClientException {
        return enrichWithSpeechWithHttpInfo(word).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<String> enrichWithSpeechWithHttpInfo(String word) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'word' is set
        if (word == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'word' when calling enrichWithSpeech");
        }
        ...
        return apiClient.invokeAPI("/api/dict/enrichWithSpeech", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
