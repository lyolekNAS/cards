...
| [**findWordToSuggest1**](DictionaryControllerApi.md#findWordToSuggest1) | **GET** /api/dict/findWordToSuggest/{level} |  |
...
> WordDto enrichWithAiTranslations(word)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            WordDto result = apiInstance.enrichWithAiTranslations(word);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DictionaryControllerApi#enrichWithAiTranslations");
...
public class Example {
    public static void main(String[] args) {
        ...
        DictionaryControllerApi apiInstance = new DictionaryControllerApi(defaultClient);
        try {
            WordDto result = apiInstance.findWordToSuggest();
            System.out.println(result);
        } catch (ApiException e) {
...
> WordDto findWordToSuggest1(level)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            WordDto result = apiInstance.findWordToSuggest1(level);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DictionaryControllerApi#findWordToSuggest1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        DictionaryControllerApi apiInstance = new DictionaryControllerApi(defaultClient);
        try {
            WordDto result = apiInstance.getNewWord();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DictionaryControllerApi#getNewWord");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
